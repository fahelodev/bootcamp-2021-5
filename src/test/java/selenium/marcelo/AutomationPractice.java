...
public class AutomationPractice {
    ...
    public void act02() {
        ...
        Assert.assertTrue(resultadoBusqueda1.getText().equals(resultado));
    ...
    public void act03() {
        ...
        Assert.assertTrue(resultadoBusqueda.getText().equals("No results were found for your search \"liquido matapulgas\""));
    ...
    @Test
    public void act04() throws InterruptedException {
       WebElement buscar=  driver.findElement(By.xpath("//*[@id=\"search_query_top\"]"));
        buscar.sendKeys("blo");
        ...
        Assert.assertTrue(resultadoBusqueda.getText().equals(resultado));
/*
  ...
  */// explicito
    ...
    @Test
    public void act05() throws InterruptedException {
