...
public class atcAutomation {
    ...
    public void atc01_AgregarReview() {
        ...
        driver.findElement(By.xpath("//*[@id='comment']")).sendKeys(" Producto que podria mejorar en el futuro");
        driver.findElement(By.cssSelector("#author")).sendKeys("Giuliano Ortego");
        driver.findElement(By.cssSelector("#email")).sendKeys("eleju.040@gmail.com");
