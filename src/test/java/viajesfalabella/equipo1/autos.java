...
public class autos {
    ...
    public void CdP12_busquedaAutos() {
        ...
        Assert.assertEquals("Ingresa un lugar de arriendo.",entrega);
        Assert.assertEquals("Ingresa una fecha de inicio.",retiro);
        Assert.assertEquals("Ingresa una fecha de finalización.",devolucion);
    }

    @Test
    public void CdP10_agregarAutos() {

        List<WebElement> categorias = driver.findElements(By.cssSelector("div.header-products-container ul li a"));

        busqueda(categorias,"Autos");

        seleccionarEntrega("Amsterdam","Aeropuerto Schiphol, Amsterdam, Holanda");

        seleccionarRetiro( 1,"13:00");

        seleccionarDevolucion(7,"09:00");
